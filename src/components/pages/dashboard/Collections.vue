<template>
  <div class="mb-4">
    <v-card>
      <v-card-title class="break-word">
        <v-row class="pa-0 ma-0">
          <v-col>
            <div>Collections</div>
            <div class="subtitle-1 line-height-x1">
    ...
    <v-dialog scrollable max-width="500" v-model="new_collection.model">
      <v-card
      ...
      >
        <v-card-title>
          <v-row>
            ...
            <v-col cols="auto" class="py-0">
              <v-btn @click="new_collection.model = false" icon>
        ...
        <v-card-text class="pt-4">
          <v-text-field
            ...
            filled
            rounded
            hint="* It's prefered to use a keywords describe the type of questions in your collection."
            persistent-hint
          ...
          <div v-show="new_collection.show_advanced">
            ...
            <v-file-input
              ...
              hint="* Upload a background cover to your collection. Only accepts JPEG and PNG formats."
              persistent-hint
              prepend-icon=""
        ...
        <v-card-actions>
          ...
          <v-menu offset-y transition="slide-y-transition">
            <template v-slot:activator="{ on }">
              <v-btn outlined color="primary" large class="text-none" v-on="on">
                <v-icon
                  v-text="
